...
// OS + OOP Assignment CPU Scheduling Algorithm Simulator in C++
// main.cpp file, it contains all of the code; no multi file structuring is done in here
// github repo link https://github.com/blacklistperformer/CPU-Scheduling-Algorithm-Simulator-in-cpp.git
...
// Defining all the appropriate classes and their data members and functions
...
public:
    ...
    //File Handling of the process.txt with rest of the information in it
    void printProcess()
    {
        ofstream print;
